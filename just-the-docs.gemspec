...
Gem::Specification.new do |spec|
  ...
  spec.files = `git ls-files -z`.split("\x0").reject { |f| f.end_with?('.jpg', '.png') }.select { |f| f.match(%r{^(assets|bin|_layouts|_includes|lib|Rakefile|_sass|LICENSE|README|CHANGELOG|favicon)}i) }
