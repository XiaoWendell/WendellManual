...
The `nav_exclude` parameter does not affect the [breadcrumbs]({% link docs/Usage Guidelines/navigation/parents.md %}), nor the [lists of child pages]({% link docs/Usage Guidelines/navigation/children.md %}), which you can use to access pages excluded from the main navigation.
